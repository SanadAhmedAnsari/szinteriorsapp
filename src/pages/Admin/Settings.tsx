...
import { Save, Globe, Palette, Mail, Phone, MapPin, Share2 } from 'lucide-react';
    ...
    <div className="space-y-12">
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="mt-2 text-stone-500 text-sm uppercase tracking-widest">Manage your global website configuration</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        {/* General Info */}
        <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-stone-100 space-y-8">
          <div className="flex items-center space-x-4">
            ...
            <h2 className="text-xl font-bold text-stone-900">General Information</h2>
          </div>
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-stone-400">Site Description</label>
              <textarea
        ...
        <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-stone-100 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-stone-400">Office Address</label>
              <input
        ...
        <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-stone-100 space-y-8">
          <div className="flex items-center space-x-4">
            ...
            <h2 className="text-xl font-bold text-stone-900">Social Media Links</h2>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {['facebook', 'instagram', 'linkedin', 'youtube', 'pinterest'].map((platform) => (
              <div key={platform} className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-stone-400 capitalize">{platform}</label>
                <input
        ...
        <div className="bg-stone-900 p-10 rounded-[2.5rem] shadow-sm text-white space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-stone-500">Primary Color</label>
              <div className="flex items-center space-x-4">
                <input
                  type="color"
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-stone-500">Font Family</label>
              <select
