...
const testimonials = [
  ...
  },
  {
    ...
    content: 'Our retail store in DB Mall area looks stunning, thanks to the creative vision of the Apka Interior Wala team. They understood our requirements and delivered a space that attracts customers and enhances the shopping experience.',
    rating: 4,
